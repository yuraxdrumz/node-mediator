  ...
  rows: [
    {
      ...
      kind: 1,
      name: '"types/Listener"',
      url: 'modules/_types_listener_.html',
    ...
    },
    {
      ...
      kind: 4194304,
      name: 'Listener',
      url: 'modules/_types_listener_.html#listener',
      classes: 'tsd-kind-type-alias tsd-parent-kind-external-module',
      parent: '"types/Listener"'
    },
    {
      id: 2,
      kind: 65536,
      name: '__type',
      url: 'modules/_types_listener_.html#listener.__type',
      classes: 'tsd-kind-type-literal tsd-parent-kind-type-alias tsd-is-not-exported',
      parent: '"types/Listener".Listener'
    },
    {
      id: 3,
      kind: 1,
